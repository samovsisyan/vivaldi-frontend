              ...
              <div className="col-12 col-lg-7">
                <div className="top_single_area d-flex align-items-center">
                  <div className="top_logo">
                    <Link to="#">
                      <img
                        src="images/core-images/logo.png"
                        alt=""
                      /></Link>
                  </div>
                    ...
                    <div className="cart">
                      ...
                      <ul className="cart-list">
                        ...
                        <li>
                          <Link to="#" className="image">
                            <img
                              src="images/product-images/product-11.jpg"
                              className="cart-thumb"
                              alt=""
                            />
                          </Link>
            ...
            <div className="row h-100">
              <div className="col-12 d-md-flex justify-content-between">
                <div className="header-social-area">
                  <Link to="#"><span className="karl-level">Կիսվել</span>
                    <i className="fa fa-pinterest" aria-hidden="true"/>
                  </Link>
                  <Link to="#"><i className="fa fa-facebook" aria-hidden="true"/>
                  </Link>
                  <Link to="#"><i className="fa fa-twitter" aria-hidden="true"/>
                  </Link>
                  <Link to="#"><i className="fa fa-linkedin" aria-hidden="true"/>
                  </Link>
                </div>
                <div className="main-menu-area">
                  <nav className="navbar navbar-expand-lg align-items-start">
                    ...
                    {menuOpen ?
                      <div className=" navbar-collapse align-items-start "
                           id="karl-navbar">
                        <ul className="navbar-nav animated"
                            id="nav">
                          <li className="nav-item active">
                            <Link className="nav-link"  to="/">Գլխավոր</Link></li>
                          <li className="nav-item">
                            <Link className="nav-link" to="/shop">Տեսականի</Link></li>
                          <li className="nav-item">
                            <Link className="nav-link" to="#">Կապ</Link></li>
                        </ul>
                      </div>
                      : null
                    }
